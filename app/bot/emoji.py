...
ICONS: dict[str, tuple[str, str]] = {
    ...
    "install": ("\U0001f4d6", "5226512880362332956"),  # 📖 как установить
    "laptop": ("\U0001f4bb", "5431376038628171216"),   # 💻 Windows
    "phone": ("\U0001f4f1", "5407025283456835913"),    # 📱 Android & iOS
    "globe": ("\U0001f30e", "5397575638146110953"),     # 🌍 бесплатные прокси
}
